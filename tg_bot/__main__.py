        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="💃🏽 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="💞 Mlayalam chat group", url="https://t.me/malayalam_chatgroup")],
                     [InlineKeyboardButton(text="🦄 Support Group", url="https://t.me/KeralaBots"), InlineKeyboardButton(text="🦄 Monuuz Channel", url="https://t.me/moonuuuzking")],
                     [InlineKeyboardButton(text="💞 Babygif Channel", url="https://t.me/cutebabygif916"), InlineKeyboardButton(text="🙈 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
